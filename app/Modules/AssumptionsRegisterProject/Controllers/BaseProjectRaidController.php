...
/**
 * File documentation for app/Modules/AssumptionsRegisterProject/Controllers/BaseProjectRaidController.php.
 */
...
abstract class BaseProjectRaidController extends BaseController
{
    ...
    public function index(int $projectId): string|RedirectResponse
    {
        ...
        $entryModel = new AssumptionsRaidEntryModel();
     ...
     */
    private function queryEntries(AssumptionsRaidEntryModel $entryModel, int $projectId): array
    {
        $builder = $entryModel
