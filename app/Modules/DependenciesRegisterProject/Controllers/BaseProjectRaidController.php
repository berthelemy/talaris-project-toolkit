...
/**
 * DependenciesRegisterProject module controller: BaseProjectRaidController.
 */
...
abstract class BaseProjectRaidController extends BaseController
{
    ...
    public function index(int $projectId): string|RedirectResponse
    {
        ...
        $entryModel = new DependenciesRaidEntryModel();
     ...
     */
    private function queryEntries(DependenciesRaidEntryModel $entryModel, int $projectId): array
    {
        $builder = $entryModel
