...
class IssueTrackerController extends BaseController
{
    public function index(int $projectId): string|RedirectResponse
    {
        ...
        return view('App\Modules\IssueTrackerProject\Views\index', [
            'project' => $project,
            'entries' => $entries,
        ]);
    }
    ...
    public function create(int $projectId): RedirectResponse
    {
        ...
        return redirect()->to('/projects/' . $projectId . '/modules/issue-tracker')
