...
<div class="card mb-4">
    <div class="card-header bg-light d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0"><?= esc(lang('Module.issuesWidgetHighPriorityTitle')) ?></h5>
        <div class="btn-group btn-group-sm" role="group">
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#issueHighPriorityModalAdd"><?= esc(lang('Module.addNew')) ?></button>
...
<div class="modal fade" id="issueHighPriorityModalAdd" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="<?= site_url('projects/' . $scope_id . '/modules/issue-tracker') ?>">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label" for="issue-high-priority-title"><?= esc(lang('Module.raidColumnTitle')) ?></label>
                        <input id="issue-high-priority-title" class="form-control" name="title" type="text" maxlength="200" required>
                    </div>
                </div>
