...
/**
 * RiskRegisterProject module controller: BaseProjectRaidController.
 */
...
abstract class BaseProjectRaidController extends BaseController
{
    ...
    public function index(int $projectId): string|RedirectResponse
    {
        ...
        $entryModel = new RiskRaidEntryModel();
     ...
     */
    private function queryEntries(RiskRaidEntryModel $entryModel, int $projectId): array
    {
        $builder = $entryModel
