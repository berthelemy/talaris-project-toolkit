...
<head>
    ...
    <title><?= esc(lang('Module.riskRegisterTitle')) ?></title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <?= view('layouts/theme_assets') ?>
</head>
<body class="bg-light">
<?= view('layouts/app_header', ['pageTitle' => lang('Module.riskRegisterTitle'), 'active' => 'projects']) ?>
<main class="container py-4">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="post" action="<?= site_url('projects/' . (int) ($project['id'] ?? 0) . '/modules/risk-register') ?>" class="row g-2 align-items-end">
                <?= csrf_field() ?>
